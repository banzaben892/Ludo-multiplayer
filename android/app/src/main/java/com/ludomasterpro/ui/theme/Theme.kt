...
fun LudoMasterTheme(content: @Composable () -> Unit) {
    MaterialTheme(
        ...
        typography  = Typography(
            headlineLarge  = TextStyle(FontFamily.Monospace, FontWeight.ExtraBold, 26.sp),
            headlineMedium = TextStyle(FontFamily.Monospace, FontWeight.Bold,      20.sp),
            titleLarge     = TextStyle(FontFamily.Monospace, FontWeight.Bold,      18.sp),
            bodyLarge      = TextStyle(FontFamily.Monospace, FontWeight.Normal,    14.sp),
            bodyMedium     = TextStyle(FontFamily.Monospace, FontWeight.Normal,    13.sp),
            bodySmall      = TextStyle(FontFamily.Monospace, FontWeight.Normal,    11.sp),
            labelSmall     = TextStyle(FontFamily.Monospace, FontWeight.Normal,    10.sp, color = LudoColors.TextSub),
        ),
        content = content
    )
}
