                ...
                if (tab == 0 || tab == 1) {
                    ...
                    if (message.isNotEmpty()) {
                        Surface(shape = RoundedCornerShape(10.dp),
                                color = Color(0xFF1A3A1A), border = BorderStroke(1.dp, Green)) {
                            Text(message, Modifier.padding(12.dp), color = Green, fontSize = 13.sp)
                        }
                    }
                    ...
                    Button(
                        ...
                        shape    = RoundedCornerShape(12.dp),
                        colors   = ButtonDefaults.buttonColors(
                            containerColor = if (tab == 0) Green else LudoColors.Accent,
                    ...
                    Surface(shape = RoundedCornerShape(10.dp), color = Color(0xFF0A0A1E)) {
                        Text(
                            ...
                            Modifier.padding(12.dp), color = TextDim, fontSize = 11.sp,
...
fun WalletTxRow(tx: WalletTx) {
    ...
    val color    = if (isCredit) Green else LudoColors.Accent
        ...
        Row(Modifier.padding(14.dp), verticalAlignment = Alignment.CenterVertically) {
            ...
            Column(horizontalAlignment = Alignment.End) {
                ...
                Text(tx.status, fontSize = 10.sp, color = when(tx.status) {
                    "success" -> Green; "pending" -> LudoColors.Primary
    ...
    Box(
        ...
        selectedComp?.let { comp ->
            ColorPickerDialog(
                comp      = comp,
                balance   = balance,
                onConfirm = { color -> onJoin(comp, color); selectedComp = null },
    ...
    if (competitions.isEmpty()) {
        Box(Modifier.fillMaxSize(), Alignment.Center) {
            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                ...
                Text("Revenez plus tard !", color = TextDim, fontSize = 12.sp)
            }
        }
    } else {
        Column(
            ...
            Row(verticalAlignment = Alignment.CenterVertically,
                ...
                Column {
                    ...
                    Text(formatCDF(comp.entryFee), fontSize = 13.sp,
                         ...
                         color = if (canAfford) Green else LudoColors.Accent)
                }
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
